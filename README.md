# 🎓 Kinel Academy — Intro to Web Dev: Teaching Project

## Project: Alex's Developer Portfolio

A personal portfolio website built **incrementally across 9 weeks**.
Each week, students add new concepts directly onto this real, growing project.
...
├── css/
│   └── style.css       ← All styles (grows each week)
├── js/
│   └── script.js       ← All JavaScript (grows each week)
└── README.md           ← This file
```

---

## ✅ Final Project Checklist (Week 9)

- [ ] Minimum 2 pages of valid, semantic HTML
- [ ] CSS variables, Flexbox, and at least one `@media` query
- [ ] At least one working JavaScript interactive element
- [ ] Mobile-friendly at 375px screen width
- [ ] Deployed live on GitHub Pages
- [ ] Real content — your name, your words, your work
...
Every time you save a file, Live Server refreshes the browser instantly.
